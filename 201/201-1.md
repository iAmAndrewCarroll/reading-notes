...
* Versatile & beginner-friendly.  
  * Wiht more experience you'll be able to create games, animated 2D & 3D graphics, comprehensive database-driven apps, and more
...
* Stippets of text taht can be added along with code.  Browsers ignor text marked as comments.  Comments in JS are done just like in CSS
